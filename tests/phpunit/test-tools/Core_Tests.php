...
class Core_Tests extends Base\TestCase {
	...
	public function test_setup() {
		// Setup
		\WP_Mock::expectActionAdded( 'init', 'NickDavis\Team\Core\i18n' );
		\WP_Mock::expectActionAdded( 'init', 'NickDavis\Team\Core\init' );
		\WP_Mock::expectAction( 'nd_team_loaded' );
	...
	public function test_i18n() {
		...
		\WP_Mock::onFilter( 'plugin_locale' )->with( 'en_US', 'nd-team' )->reply( 'en_US' );
		\WP_Mock::userFunction( 'load_textdomain', array(
			'times' => 1,
			'args' => array( 'nd-team', 'lang_dir/nd-team/nd-team-en_US.mo' ),
		) );
		...
		\WP_Mock::userFunction( 'load_plugin_textdomain', array(
			'times' => 1,
			'args' => array( 'nd-team', false, 'path/languages/' ),
		) );
	...
	public function test_init() {
		// Setup
		\WP_Mock::expectAction( 'nd_team_init' );
